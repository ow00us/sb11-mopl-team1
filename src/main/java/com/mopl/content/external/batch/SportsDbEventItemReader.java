...
public class SportsDbEventItemReader implements ItemReader<SportsDbEventSummary> {
    ...
    public SportsDbEventItemReader(SportsDbApiClient sportsDbApiClient, List<Integer> leagueIds, List<LocalDate> dates) {
        this.sportsDbApiClient = sportsDbApiClient;
